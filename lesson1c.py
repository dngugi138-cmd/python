...
# modulus
# This means the remainder of a number when it gets subdivided by another number
number9 = 27
number10 = 8
modulus = number9 % number10
print('The modulus of the numbers is: ', modulus)

# Floor divisions is the number of times a number subdivides another ignoring the remainder
